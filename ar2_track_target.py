        ...
        if len(msg.markers) != 0:
            ...
            for msg in msg.markers:
                ...
                if msg.id == TARGET_ID:
                    ...
                    if self.is_found_target_1st_time == False:
                        ...
                        print "theta at 1st find Marker = %s" %(self.theta1)
                    ...
                    if self.align_finished == True:
                        print "theta = " %(self.ar_pose.theta)
            ...
            if self.is_found_target_1st_time == True:
                if self.is_lost_target_1st_time == False:
                    ...
                    print "theta at 1st lost marker = %s" %(self.theta2)
                    self.start_move = False
                    self.tw.angular.z = 0.0
                    self.pub.publish(self.tw)
                    ...
                    if self.align_finished == False:
                        print "ar_pose.y = " %(self.ar_pose.y)
            self.found_target = False
